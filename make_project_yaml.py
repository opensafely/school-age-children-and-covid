...
add_action(
    "WORMS_02_an_data_checks", needs="01_cr_analysis_dataset",
)
...
for outcome in outcomes:
    ...
    for key in interaction_keys:
        ...
        if key == "sex" and outcome == "covidadmission":
            output = (
                f"output/an_interaction_cox_models_{outcome}_*_MAINFULLYADJMODEL_*.ster"
            )
        else:
            output = f"output/an_interaction_cox_models_{outcome}_*.ster"
        add_action(
