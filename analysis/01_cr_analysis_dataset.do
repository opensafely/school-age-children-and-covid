...
gen itu_admission = (icu_date_admitted < .)
...
replace itu_admission = 0 if (icu_date_admitted > onscoviddeathcensor_date)
...
label var  itu_admission				"Failure/censoring indicator for outcome: itu_admission"
