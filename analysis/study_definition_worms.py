...
study = StudyDefinition(
    ...
    has_12_m_follow_up=patients.registered_with_one_practice_between(
        "2018-02-01", "2019-01-31", ### 6 months prior to 1st Feb 2019
        return_expectations={
            "incidence" : 0.95,
        }
    ),
    has_3_m_follow_up=patients.registered_with_one_practice_between(
        "2018-11-01", "2019-01-31", ### 3 months prior to 1st Feb 2019
        return_expectations={
            "incidence" : 0.95,
        }
    ),
    ...
    creatinine=patients.with_these_clinical_events(
        ...
        return_expectations={
            ...
            "date": {"earliest": "2018-02-28", "latest": "2019-01-31"},
            "incidence": 0.95,
        },
    ),
    ...
    chronic_respiratory_disease=patients.with_these_clinical_events(
        ...
        return_first_date_in_period=True,
        include_month=True,
        return_expectations={"date": {"latest": "2019-01-31"}},
    ),
    ...
    temporary_immunodeficiency=patients.with_these_clinical_events(
        combine_codelists(temp_immune_codes,
                        aplastic_codes),
        between=["2018-02-01", "2019-01-31"],  ## THIS IS RESTRICTED TO LAST YEAR
        return_last_date_in_period=True,
        include_month=True,
        return_expectations={
            "date": {"earliest": "2018-03-01", "latest": "2019-01-31"}
        },
    ),
    ...
    asthma=patients.categorised_as(
        ...
        recent_asthma_code=patients.with_these_clinical_events(
            asthma_codes, between=["2017-02-01", "2019-02-01"],
        ),
