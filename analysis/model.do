...
winexec "C:\Program Files (x86)\Stata15\Stata-64.exe" do "07d_an_multivariable_cox_models_FULL_Sense1.do" `outcome'
}
...
************************************************************
foreach outcome of any non_covid_death covid_tpp_prob covidadmission covid_icu covid_death {
winexec "C:\Program Files (x86)\Stata15\Stata-64.exe" do "07d_an_multivariable_cox_models_FULL_Sense2.do" `outcome'
}
